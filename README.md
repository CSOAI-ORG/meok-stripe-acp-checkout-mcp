...
[![MCP Scorecard: 90/100](https://img.shields.io/badge/proofof.ai-90%2F100-5b21b6)](https://proofof.ai/scorecard/meok-stripe-acp-checkout-mcp.html)
...
```json
{
  "mcpServers": {
    "meok-stripe-acp-checkout-mcp": {
      "command": "uvx",
      "args": ["meok-stripe-acp-checkout-mcp"]
    }
  }
}
```

Or: `pip install meok-stripe-acp-checkout-mcp` then run the `meok-stripe-acp-checkout-mcp` command (stdio transport).
